...
# --- Constants ---
LOOKBACK_BULL=20; LOOKBACK_BEAR=25
BEAR_VOL_MULT=1.10; BEAR_ATR_FRAC=0.15
ADX_LEN=14; RMI_LEN=20; RMI_MOM=5
TF_MAP={
    "1Min":TimeFrame(1,TimeFrameUnit.Minute),"5Min":TimeFrame(5,TimeFrameUnit.Minute),
    "15Min":TimeFrame(15,TimeFrameUnit.Minute),"1H":TimeFrame(1,TimeFrameUnit.Hour),
    "4H":TimeFrame(4,TimeFrameUnit.Hour),"1D":TimeFrame(1,TimeFrameUnit.Day),
